...
export function Features() {
  const features = [
    ...
    },
    {
      title: 'Database',
      description:
        'Designed and maintained scalable databases with optimized queries for performance.',
      icon: <IconCloud />,
    },
    {
      title: 'Version Control',
      description:
        'Proficient in using Git for version control, ensuring seamless collaboration and code management.',
    ...
    },
    {
      title: 'Performance',
      description:
        'Focused on optimizing web applications for speed and performance, ensuring a smooth user experience.',
