      ...
      <div className="w-full h-auto flex lg:flex-row md:flex-row sm:flex-col z-10 py-20 px-5 relative justify-center items-center">
        <div className="w-[50%] sm:w-full flex flex-col justify-center items-start px-5 sm:px-3  sm:items-center">
          <h2 className=" uppercase tracking-normal text-center text-blue-100 pb-5">
            ...
            >
              <span className="text-sm md:text-xs sm:text-xs font-silkscreen">
                Hein Htet, Full-Stack Developer.
              </span>
            </HoverBorderGradient>
          </h2>
          <TextGenerateEffect
            className=" w-[80%] lg:w-[100%] font-righteous text-pretty pb-5 sm:text-center text-[50px] lg:text-[40px] md:text-[36px] sm:text-[33px] "
            words={'In the world of development, possibilities are limitless.'}
          />
          <div className="w-[80%] sm:w-[100%] items-start h-26 lg:h-56 md:h-56 sm:h-44 leading-8 text-[18px] lg:text-[16px] md:text-[15px] text-left sm:text-center mb-5 font-normal text-neutral-600 dark:text-neutral-400">
            With expertise in full stack development, I build{' '}
            <FlipWords words={words} className=" px-0" /> websites that deliver
            exceptional user experiences. I’m currently studying Computer
            Science at Rangsit University, building a strong foundation in
