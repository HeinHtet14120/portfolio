      ...
      <div className=" w-full h-auto my-16 flex md:flex-col sm:flex-col items-center dark:bg-black-100 dark:bg-grid-neutral-200/[0.2] bg-grid-black/[0.2] bg-small-grid relative">
        ...
        <div className=" w-[50%] md:w-full sm:w-full text-center md:mb-5 sm:mb-5">
          <div className=" w-full ">
            <h1 className=" w-[80%] text-left pl-7 sm:w-[70%] sm:text-center sm:pl-0 sm:mx-auto md:mx-auto lg:text-left text-5xl lg:text-4xl md:text-3xl sm:text-3xl mb-3 text-neutral-200 font-extrabold leading-snug sm:leading-10 sm:my-8">
              Ready to Bring Your Ideas to Life?
            </h1>
            <p className=" w-[80%] pl-7 sm:w-[70%] sm:text-justify sm:pl-0 sm:mx-auto md:mx-auto text-justify text-neutral-400 leading-6 text-md sm:mb-8">
              If you're looking for innovative solutions or creative
              collaboration, I’m here to help. Get in touch today, and let’s
              discuss how we can make your project a reality!
            </p>
          </div>
